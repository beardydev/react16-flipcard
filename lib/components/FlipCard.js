...
exports['default'] = _createReactClass({
  ...
  flipcardMounted: false,

  propTypes: {
    type: _propTypes.string,
    flipped: _propTypes.bool,
    disabled: _propTypes.bool,
    onFlip: _propTypes.func,
  ...
  handleFocus: function handleFocus() {
    if (this.props.disabled || !this.flipcardMounted) return;
